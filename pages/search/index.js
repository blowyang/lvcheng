...
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.data != null) {
          ...
          var allGoods = app.globalData.goods    
          var temGoods = res.data.data;
          for (var i = 0; i < temGoods.length; i++) {
            var temGood = temGoods[i]
            var temGoodId = temGood.id
  ...
  refreshGoodsList: function () {
    ...
    that.loadSearchContent(that.data.keyword, that.data.pageNum, that.data.pageSize);
  },
